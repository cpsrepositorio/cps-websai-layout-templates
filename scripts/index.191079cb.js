...
})({"2XNAK":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "49a22a94191079cb";
...
},{}],"ih7PJ":[function(require,module,exports) {
var _colorSchemeJs = require("./color-scheme.js");

},{"./color-scheme.js":"1lltR"}],"1lltR":[function(require,module,exports) {
...
function detectColorScheme() {
    ...
    else if (matchMedia && matchMedia("(prefers-color-scheme: dark)").matches) theme = "dark";
    if (colorSchemeSelector) colorSchemeSelector.addEventListener("click", ()=>{
        if (isColorSchemeDark()) updateColorScheme("light");
        else updateColorScheme("dark");
    });
    updateColorScheme(theme);
}
detectColorScheme();

},{}]},["2XNAK","ih7PJ"], "ih7PJ", "parcelRequireea95")

//# sourceMappingURL=index.191079cb.js.map
